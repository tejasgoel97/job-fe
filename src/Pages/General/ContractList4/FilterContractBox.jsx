...
import Pagination from "@/components/job-listing-page/Pagination";
      ...
      <div className="job-block col-lg-6 col-md-12 col-sm-12" key={item.id}>
        <div className="inner-box">
          <div className="content">
            ...
            <h4>
              <Link to={`/contract/${item._id}`}>{item.title}, {item.companyId.infoData.companyName}</Link>
            </h4>
    ...
    <div className="ls-outer">
      <div className="ls-switcher">
        <div className="showing-result show-filters">
          ...
          <div className="text">
            <strong>{content?.length}</strong> contracts
          </div>
        </div>
        {/* End showing results */}
